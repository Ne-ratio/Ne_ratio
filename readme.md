...
```
After the computation finishes, it outputs a long-format file ready for plotting in R, along with the Wilcoxon test results. Feed that long-format file into the accompanying R script（Ne_result.R） to generate the final figure.
